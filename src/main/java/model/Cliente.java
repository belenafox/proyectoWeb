...
public class Cliente extends Usuario {
	...
	public Cliente(int id, String nombre, String fechaNacimiento, String rutUsuario, String tipo, String telefono, String afp, int sistemaDeSalud,
	...
	public String toString() {
		return "Cliente [telefono=" + telefono + ", afp=" + afp + ", sistemaDeSalud=" + sistemaDeSalud + ", direccion="
				+ direccion + ", comuna=" + comuna + ", edad=" + edad + ", getId()=" + getId() + ", getNombre()="
				+ getNombre() + ", getFechaNacimiento()=" + getFechaNacimiento() + ", getRutUsuario()="
				+ getRutUsuario() + ", getTipo()=" + getTipo() + "]";
	}
